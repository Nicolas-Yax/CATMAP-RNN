...
class PreRNN(RNNAgent):
    """ Agent using a RNN to solve the PRE task """
    def __init__(self,hidden_shape,input_shape=(None,2),out_shape=2,context_input_shape=(2,),lr=10**-3,noise=None,random_training=False,activation='tanh'):
